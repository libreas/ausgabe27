...
> "Heute leben wir im Imaginären des Bildschirms, des Interface und der
...
[^10]: Die "Wissensspirale oder auch SECI-Prozess (Socialisation,
    Externalisation, Combination and Internalisation). Nonaka und
    Takeuchi gingen hier den so wichtigen Schritt Wissen nicht mehr als
    objektive Entität zu betrachten, sondern als einen sozialen
    Konstruktionsprozess. Das Werk prägte vor allem die zweite
